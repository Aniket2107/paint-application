 ...
 *
 * \brief Common register and bits definitions.
 *
 *
 * Review status: NO
 *
...
#define PWR_TIMER0				BIT_MASK_1
#define PWR_TIMER1				BIT_MASK_2
#define PWR_UART0				BIT_MASK_3
#define PWR_UART1				BIT_MASK_4
// Bit 5 in PCONP is reserved
#define PWR_PWM1				BIT_MASK_6
#define PWR_I2C0				BIT_MASK_7
#define PWR_SPI					BIT_MASK_8
#define PWR_RTC					BIT_MASK_9
#define PWR_SSP1				BIT_MASK_10
// Bit 11 in PCONP is reserved
#define PWR_ADC					BIT_MASK_12
...
#define PWR_I2C1				BIT_MASK_19
// Bit 20 in PCONP is reserved
#define PWR_SSP0				BIT_MASK_21
#define PWR_TIMER2				BIT_MASK_22
#define PWR_TIMER3				BIT_MASK_23
#define PWR_UART2				BIT_MASK_24
#define PWR_UART3				BIT_MASK_25
#define PWR_I2C2				BIT_MASK_26
#define PWR_I2S					BIT_MASK_27
// Bit 28 in PCONP is reserved
#define PWR_GPDMA				BIT_MASK_29
#define PWR_ENET				BIT_MASK_30
#define PWR_USB					BIT_MASK_31
