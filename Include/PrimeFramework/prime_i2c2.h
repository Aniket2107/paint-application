...
/**
 * The function initializes the I2C2 channel with provided settings
 *
...
/**
 * The function turns off the I2C2 channel
 */
PFEnStatus pfI2c2Close(void);

/**
 * The function enables I2C2 interrupt
 * 
...
/**
 * The function disables I2C2 interrupt
 * 
...
/**
 * The function sets the given flag in I2C2 control register
 *
...
/**
 * The function clears the given flag in I2C2 control register
 *
...
/**
 * The function gives current I2C2 communication state
 *
 ...
 */
PFEnStatus pfI2c2Write(PFbyte* data, PFEnBoolean master, PFbyte slaveAddr,PFEnBoolean busRelease, PFdword size);
 ...
 * Otherwise it will wait in the function andreceive each byte by polling the line status.
 *
 ...
 */
PFEnStatus pfI2c2Read(PFbyte* data, PFEnBoolean master, PFbyte slaveAddr,PFEnBoolean busRelease, PFdword size, PFdword* readBytes);
